...
def plot_sensitivity_pr(indices,indices_pval,frac_var,path_fig):
    ...
    plt.title('c) Sea Surface Temperature (Ecuatorial)',fontsize=18)
    ...
    plt.title('d) Sea Surface Temperature (Tropical)',fontsize=18)
...
def plot_sensitivity_ua(indices,indices_pval,frac_var,path_fig):
    ...
    plt.savefig(path_fig+'/u850DJFsensitivities_TW_VB_SSTs.png',bbox_inches='tight')
    plt.clf
...
def plot_sensitivity_psl(indices,indices_pval,frac_var,path_fig):
    ...
    plt.savefig(path_fig+'/pslDJFsensitivities_TW_VB_SSTs.png',bbox_inches='tight')
    plt.clf
